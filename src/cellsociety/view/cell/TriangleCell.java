...
public class TriangleCell extends Cell {
    ...
    public TriangleCell(SimulatorController simulatorController, int orientation, int xCoordinate, int yCoordinate){
        ...
        if(orientation == 0) this.getPoints().addAll(0.0, TRIANGLE_HEIGHT, TRIANGLE_WIDTH/2, 0.0, TRIANGLE_WIDTH, TRIANGLE_HEIGHT);
        if(orientation == 1) this.getPoints().addAll(0.0,0.0, TRIANGLE_WIDTH,0.0, TRIANGLE_WIDTH/2,TRIANGLE_HEIGHT);
